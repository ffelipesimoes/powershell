...
$Lastupdatetime_XP = Get-Content E:\WsusDados\Repository_PowerShell\FORUM\DateLastApplyUpdate_XP.txt
...
($updates_XP | Select-Object -Last 1 creationdate | ft -HideTableHeaders  | Out-String).Trim() |Out-File E:\WsusDados\Repository_PowerShell\FORUM\DateLastApplyUpdate_XP.txt

# Listar os 50 updates para Windows 7
#$lastupdatetime_7 = "10/03/2009 00:00:00"
#Lendo a ultima data setada
$lastupdatetime_7 = Get-Content E:\WsusDados\Repository_PowerShell\FORUM\DateLastApplyUpdate_7.txt
...
Select-Object -First 50  KnowledgebaseArticles,CreationDate,ProductTitles
#Exportando dados para texto
($updates_7 | Select-Object -Last 1 creationdate | ft -HideTableHeaders  | Out-String).Trim() |Out-File E:\WsusDados\Repository_PowerShell\FORUM\DateLastApplyUpdate_7.txt
 

# Listar os 50 updates para Windows 8.1
#$lastupdatetime_81 = "08/10/2013 00:00:00"
#Lendo a ultima data setada
$lastupdatetime_81 = Get-Content E:\WsusDados\Repository_PowerShell\FORUM\DateLastApplyUpdate_81.txt
...
Select-Object -First 50  KnowledgebaseArticles, creationdate,ProductTitles
#Exportando dados para texto
($updates_81 | Select-Object -Last 1 creationdate | ft -HideTableHeaders  | Out-String).Trim() |Out-File E:\WsusDados\Repository_PowerShell\FORUM\DateLastApplyUpdate_81.txt

# Exportar os dados acima para o arquivo
($updates_XP + $Updates_7 + $Updates_81 | ft -HideTableHeaders KnowledgebaseArticles | Out-String).Trim()| Out-File E:\WsusDados\Repository_PowerShell\FORUM\UpdatesToInstall_FORUM.txt

$fileName = "UpdateList-" + (Get-Date -Format ddMMyyyy) + ".txt"
$location = "E:\WsusDados\Repository_PowerShell\FORUM\Log_KB_Installed"
($updates_XP + $Updates_7 + $Updates_81  | Out-String).Trim() | Out-file -append -FilePath (Join-Path $location $fileName)

# Substituindo caracteres
$file_FORUM = Get-Content E:\WsusDados\Repository_PowerShell\FORUM\UpdatesToInstall_FORUM.txt
$file_FORUM = $file_FORUM.Replace('{', 'KB')
$file_FORUM = $file_FORUM.Replace('}', '')
$file_FORUM = $file_FORUM.Replace('  ', '')
$file_FORUM | Out-File E:\WsusDados\Repository_PowerShell\FORUM\UpdatesToInstall_FORUM.txt

#Aplicando Updates aos grupos no WSUS
foreach ($f_FORUM in $file_FORUM) {
$update = $wsus.SearchUpdates($f_FORUM) # Nome do KB ou atualização
