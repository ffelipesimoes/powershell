...
$Lastupdatetime_XP = Get-Content E:\WsusDados\Repository_PowerShell\DateLastApplyUpdate_XP.txt
...
($updates_XP | Select-Object -Last 1 creationdate | ft -HideTableHeaders  | Out-String).Trim() |Out-File E:\WsusDados\Repository_PowerShell\DateLastApplyUpdate_XP.txt
 

# Listar os 50 updates para Windows 7
#$lastupdatetime_7 = "10/03/2009 00:00:00"
#Lendo a ultima data setada
$lastupdatetime_7 = Get-Content E:\WsusDados\Repository_PowerShell\DateLastApplyUpdate_7.txt
...
Select-Object -First 50  KnowledgebaseArticles,CreationDate
#Exportando dados para texto
($updates_7 | Select-Object -Last 1 creationdate | ft -HideTableHeaders  | Out-String).Trim() |Out-File E:\WsusDados\Repository_PowerShell\DateLastApplyUpdate_7.txt
 

# Listar os 50 updates para Windows 8.1
#$lastupdatetime_81 = "08/10/2013 00:00:00"
#Lendo a ultima data setada
$lastupdatetime_81 = Get-Content E:\WsusDados\Repository_PowerShell\DateLastApplyUpdate_81.txt
...
Select-Object -First 50  KnowledgebaseArticles, creationdate
#Exportando dados para texto
($updates_81 | Select-Object -Last 1 creationdate | ft -HideTableHeaders  | Out-String).Trim() |Out-File E:\WsusDados\Repository_PowerShell\DateLastApplyUpdate_81.txt

# Exportar os dados acima para o arquivo
($updates_XP + $Updates_7 + $Updates_81 | ft -HideTableHeaders KnowledgebaseArticles | Out-String).Trim()| Out-File E:\WsusDados\Repository_PowerShell\UpdatesToInstall_HML.txt

# Substituindo caracteres
$file_HML = Get-Content E:\WsusDados\Repository_PowerShell\UpdatesToInstall_HML.txt
$file_HML = $file_HML.Replace('{', 'KB')
$file_HML = $file_HML.Replace('}', '')
$file_HML = $file_HML.Replace('  ', '')
$file_HML | Out-File E:\WsusDados\Repository_PowerShell\UpdatesToInstall_HML.txt
